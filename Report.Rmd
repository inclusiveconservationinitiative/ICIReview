...
p <- ggplot(summaryStats, aes(x=Average, y=Geog_Percentile, color = Geography), group = EoI) +
            geom_point(shape=1)
...
#### **Average: `r mean(subgroup$Section1_A1)`/5**
...
#### **Average: `r mean(subgroup$Section1_A2)`/2**
...
#### **Average: `r mean(subgroup$Section1_B3)`/5**
...
#### **Average: `r mean(subgroup$Section1_B4)`/2**
...
#### **Average: `r mean(subgroup$Section1_C5)`/5**
...
#### **Average: `r mean(subgroup$Section1_D6)`/3**
...
#### **Average: `r mean(subgroup$Section1_D7)`/3**
...
#### **Average: `r mean(subgroup$Section1_D8)`/3**
...
#### **Average: `r mean(subgroup$Section1_E9)`/2**
...
#### **Average Total Score: `r mean(subgroup$Section1_Total)`/30**
</div>
...
p <- ggplot(summaryStats2, aes(x=Avg_Sec_1, y=Geog_Percentile, color = Geography), group = EoI) +
            geom_point(shape=1)+
...
#### **Average: `r mean(subgroup$Section2_A1)`/3**
...
#### **Average: `r mean(subgroup$Section2_A2)`/6**
...
#### **Average: `r mean(subgroup$Section2_A3)`/3**
...
#### **Average: `r mean(subgroup$Section2_A4)`/3**
...
#### **Average: `r mean(subgroup$Section2_A5)`/3**
...
#### **Average: `r mean(subgroup$Section2_B6)`/5**
...
#### **Average: `r mean(subgroup$Section2_B7)`/3**
...
#### **Average: `r mean(subgroup$Section2_B8)`/3**
...
#### **Average: `r mean(subgroup$Section2_C9)`/3**
...
#### **Average: `r mean(subgroup$Section2_D10)`/3**
...
#### **Average: `r mean(subgroup$Section2_E11)`/5**
...
#### **Average Total Score: `r mean(subgroup$Section2_Total)`/40**
</div>
...
p <- ggplot(summaryStats2, aes(x=Avg_Sec_2, y=Geog_Percentile, color = Geography), group = EoI) +
            geom_point(shape=1)+
...
#### **Average: `r mean(subgroup$Section3_A1)`/6**
...
#### **Average: `r mean(subgroup$Section3_B2)`/6**
...
#### **Average: `r mean(subgroup$Section3_C3)`/5**
...
#### **Average: `r mean(subgroup$Section3_D4)`/5**
...
#### **Average: `r mean(subgroup$Section3_E5)`/6**
...
#### **Average: `r mean(subgroup$Section3_E6)`/2**
...
#### **Average Total Score: `r mean(subgroup$Section2_Total)`/30**
</div>
...
p <- ggplot(summaryStats2, aes(x=Avg_Sec_3, y=Geog_Percentile, color = Geography), group = EoI) +
            geom_point(shape=1)+
